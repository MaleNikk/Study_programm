...
public final class TestRepository extends TestConfiguration {
    ...
    public void whenUpdateEntity_thenReturnUpdatedObject() {
        ...
        saved = repository.takeParentSites();
        ...
        updated = repository.takeParentSites();
        ...
        for (int i = 0; i < updated.size(); i++) {
            ...
            Assertions.assertNotEquals(savedSite.getLemmas(), updatedSite.getLemmas());
            Assertions.assertNotEquals(savedSite.getPages(), updatedSite.getPages());
        }
    ...
    public void whenDeleteEntity_thenReturnIsPresent() {
        ...
        Assertions.assertNotNull(repository.takeParentSites());
        ...
        Assertions.assertEquals(List.of(),repository.takeParentSites());
